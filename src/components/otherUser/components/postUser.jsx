  ...
  return (
    <>
      <div className="publication">
       ...
       {/* <div className="publication">
        <Link to={"otherUser"} className="head-pub">
        ...
        <p>
          RATA-TWO-ILLE! <br />
          Get ready for a delectable adventure in "ratatouille", the enchanting
          Disney-Pixar sequel to ratatouille! in theater this November...
        </p>
